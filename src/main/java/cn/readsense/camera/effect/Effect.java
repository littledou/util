...
public abstract class Effect {
    ...
    public void prepare(int iw, int ih) {
    ...
    private void loadShaderAndParams(String vertex, String fragment) {
        if (TextUtils.isEmpty(vertex) || TextUtils.isEmpty(fragment)) {
            vertex = CastConstant.SHARDE_NULL_VERTEX;
            fragment = CastConstant.SHARDE_NULL_FRAGMENT;
            DLog.e(CastConstant.TAG, "Couldn't load the shader, so use the null shader!");
        }
    ...
    private void initSize(int iw, int ih) {
        mWidth = iw;
        mHeight = ih;
    }
