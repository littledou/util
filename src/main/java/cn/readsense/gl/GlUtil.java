...
public class GlUtil {
	...
	public static int createProgram(String vertexSource, String fragmentSource) {
		...
		if (linkStatus[0] != GLES20.GL_TRUE) {
			DLog.e(TAG, "Could not link program:");
			DLog.e(TAG, GLES20.glGetProgramInfoLog(program));
	...
	public static int loadShader(int shaderType, String source) {
		...
		if (compiled[0] == 0) {
			DLog.e(TAG, "Could not compile shader(TYPE=" + shaderType + "):");
			DLog.e(TAG, GLES20.glGetShaderInfoLog(shader));
	...
	public static void checkGlError(String op) {
		...
		while ((error = GLES20.glGetError()) != GLES20.GL_NO_ERROR) {
			DLog.e(TAG, op + ": glGetError: 0x" + Integer.toHexString(error));
	...
	public static void checkEglError(String op) {
		...
		while ((error = EGL14.eglGetError()) != EGL14.EGL_SUCCESS) {
			DLog.e(TAG, op + ": eglGetError: 0x" + Integer.toHexString(error));
